...
public class BookControllerTest {
    ...
    public void shouldDenyAccessToBookDetailsForGuest() throws Exception {
        given(libraryService.getBookById(FIRST_BOOK_ID)).willReturn(Optional.empty());
        this.mvc.perform(get("/book/1"))
    ...
    @Test
    @WithAnonymousUser
    public void shouldRedirectAnonymousUsersToLogin() throws Exception {
    ...
    public void shouldDenyAccessBookAddPageForUser() throws Exception {
    ...
    public void shouldAllowAccessToBookAddPageForAdmin() throws Exception {
        this.mvc.perform(MockMvcRequestBuilders.get("/book/add"))
